...
ClassFile {
    ...
    u2             constant_pool_count;--常量池的长度(实际上有【长度-1】个真正的常量表)
    cp_info        constant_pool[constant_pool_count-1];--常量池表（下标索引从1开始）
...
| **C**ONSTANT_Methodref      | 10   | 代表方法的**符号引用**                                       |
...
| CONSTANT_NameAndType        | 12   | 字段或方法的部分**符号引用**【表示字段或方法的名称和描述符】 |
| CONSTANT_Utf8               | 1    | **代表utf-8编码的字符串**                                    |
| CONSTANT_MethodHandle       | 15   | 方法**句柄**                                                 |
